...
export default function page() {
  return (
    <>
      ...
      <article class="prose px-8 mt-8 pb-16 dark:prose-invert flex flex-col w-full mx-auto">
        <div class="space-y-4">
        ...
        <div class="space-y-4">
          ...
          <h3>Contact Info</h3>
          <p>
            If you reach out via email, the info you provide is entirely up to you. I will only use
            it to reply and have a conversation with you.
          </p>
          ...
          <p>
            I <b>do not</b> sell, trade, or rent your personal info. If you shared something
            sensitive by accident, feel free to reach out, and I&apos;ll help you remove it.
          </p>
